...
description: .plugin-workspace/.specsの実装計画に沿って実装し、全タスク完了後にClaude Code CLIで一括コードレビュー（自動コンテキスト注入版）。
disable-model-invocation: true
argument-hint: "[番号]"
allowed-tools: Bash(cat .plugin-workspace/.specs/*), Bash(ls .plugin-workspace/.specs/*), Bash(grep *), Bash(claude *), Bash(mkdir *), Bash(rm .plugin-workspace/.specs/*/PLANNING), Bash(rm .plugin-workspace/.specs/.guard/*)
---
