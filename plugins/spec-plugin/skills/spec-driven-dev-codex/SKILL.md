...
allowed-tools: Bash(ls *), Bash(mkdir *), Bash(touch *), Bash(echo *), Bash(printf *), Bash(rm .plugin-workspace/.specs/*/PLANNING), Bash(rm .plugin-workspace/.specs/.guard/*), Bash(codex *)
---
...
| パラメータ | 値 |
|-----------|-----|
| SKILL_NAME | `spec-driven-dev-codex` |
