...
description: .specsの実装計画に沿って実装し、全タスク完了後にGitHub Copilot CLIで一括コードレビュー（自動コンテキスト注入版）。
disable-model-invocation: true
argument-hint: "[番号]"
allowed-tools: Bash(cat .specs/*), Bash(ls .specs/*), Bash(grep *), Bash(copilot *), Bash(mkdir *), Bash(rm .specs/*/PLANNING), Bash(rm .specs/.guard/*)
---
